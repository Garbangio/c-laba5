...
namespace edu_simple
{
    ...
    public class ErrorNotifierDerived : ErrorNotifierBase
    {
        ...
        protected override void OnError(string kind, string text)
        {
            ...
            if (handler != null)
            {
                var msg = "[Переопределенное событие] " + text;
    ...
    public class Student : IHasId, IPrintable, IMarkEditable
    {
        ...
        public void PutMark(string subject, int mark) => Marks[subject] = mark;
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            notifier.ErrorHappened += (sender, e) =>
            {
                ...
                Console.WriteLine($"ОШИБКА: {e.Kind}");
        ...
        static void Menu()
        {
            ...
            Console.WriteLine("9) Студенты без двоек и троек (в файл)");
            Console.WriteLine("10) Тест интерфейсов (делегат)");
            Console.WriteLine("11) Демонстрация обработки 7 исключений");
        ...
        static void TestStudentInterfacesWithDelegate()
        {
            ...
            tests += ActionPrint;
            tests += ActionPutDemoMark;
            tests += ActionPrint;
            tests += ActionClearMarks;
            tests += ActionPrint;

            Console.WriteLine("Запуск тестов интерфейсов:");
            tests(st);
        ...
        static void Seed()
        {
            ...
            var s2 = new Student("S002", "Надя Куховарка");
